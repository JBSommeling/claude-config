...
## Stage 2 — Fix (via `/full-pipeline`)

Run `/full-pipeline`, using the Stage 1 diagnosis as the feature request. The diagnosis is the input to Phase 1 — the pipeline specs and builds the FIX, not a new feature:
